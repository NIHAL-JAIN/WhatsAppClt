...
import com.nihal.whatsappclt.databinding.ActivitySignInBinding;
        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (binding.mail.getText().toString().isEmpty()){
                    binding.mail.setError("Enter you mail");
                    return;
                }
                ...
                auth.signInWithEmailAndPassword(binding.mail.getText().toString(),
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            Log.e(String.valueOf(SignInActivity.this), "onClick: Its password");
                        }
                        else{
